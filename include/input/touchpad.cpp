...
void getFingerData(HWND window) {
    ...
    for (u32 i = 0; i < data_length; i++) {
        switch (data[i].DataIndex) {
            // touchpad
            case 0: {
                t_state.touchPadButton = data[i].On;
            } break;
            case 1: {
                t_state.contactCount = data[i].RawValue;
            } break;
            case 2: {
                t_state.scanTime = data[i].RawValue;
            } break;
            ...
            // index0
            case 3: {
                finger_data[F1].tip_switch = data[i].On;
            } break;
            case 4: {
                finger_data[F1].confidence = data[i].On;
            } break;
            case 5: {
                finger_data[F1].id = data[i].RawValue;
            } break;
            case 6: {
                finger_data[F1].x = data[i].RawValue;
            } break;
            case 7: {
                finger_data[F1].y = data[i].RawValue;
            } break;

            // index1
            case 8: {
                finger_data[F2].tip_switch = data[i].On;
            } break;
            case 9: {
                finger_data[F2].confidence = data[i].On;
            } break;
            case 10: {
                finger_data[F2].id = data[i].RawValue;
            } break;
            case 11: {
                finger_data[F2].x = data[i].RawValue;
            } break;
            case 12: {
                finger_data[F2].y = data[i].RawValue;
            } break;

            // index2
            case 13: {
                finger_data[F3].tip_switch = data[i].On;
            } break;
            case 14: {
                finger_data[F3].confidence = data[i].On;
            } break;
            case 15: {
                finger_data[F3].id = data[i].RawValue;
            } break;
            case 16: {
                finger_data[F3].x = data[i].RawValue;
            } break;
            case 17: {
                finger_data[F3].y = data[i].RawValue;
            } break;

            // index3
            case 18: {
                finger_data[F4].tip_switch = data[i].On;
            } break;
            case 19: {
                finger_data[F4].confidence = data[i].On;
            } break;
            case 20: {
                finger_data[F4].id = data[i].RawValue;
            } break;
            case 21: {
                finger_data[F4].x = data[i].RawValue;
            } break;
            case 22: {
                finger_data[F4].y = data[i].RawValue;
            } break;

            // index4
            case 23: {
                finger_data[F5].tip_switch = data[i].On;
            } break;
            case 24: {
                finger_data[F5].confidence = data[i].On;
            } break;
            case 25: {
                finger_data[F5].id = data[i].RawValue;
            } break;
            case 26: {
                finger_data[F5].x = data[i].RawValue;
            } break;
            case 27: {
                finger_data[F5].y = data[i].RawValue;
            } break;
